...
export const PERSONAL_WEBSITE = 'https://sachinchaurasiya.dev';
export const SUCCESS_REDIRECT_URL = `${window.location.origin}${ROUTES.CALLBACK}`;
export const FAILURE_REDIRECT_URL = `${window.location.origin}${ROUTES.SIGN_IN}`;
export const EMAIL_VERIFICATION_URL = `${window.location.origin}${ROUTES.EMAIL_VERIFICATION}`;
